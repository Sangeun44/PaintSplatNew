...
public class TargetBehavior : MonoBehaviour, ITrackableEventHandler
{
    ...
    **/
     ...
     *  The dot product ensures that when Vuforia occassionally
     *  returns glitchy data for a frame or two, the changes aren't erroneously applied.
    **/
    ...
    /** Look-3.1.b
        Take a look at the next 4 functions and notice how data from either
        ARCamera or CameraProxy is returned based on whether or not there is tracking. 
    **/
